...
#ifndef VERILATED_VTESTHARNESS_AXI_MUX__PI69_H_
#define VERILATED_VTESTHARNESS_AXI_MUX__PI69_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtestharness_axi_mux__pi69 final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*7:0*/ __PVT__gen_mux__DOT__mst_b_chan;
    ...
    struct {
        ...
        CData/*7:0*/ __PVT__gen_mux__DOT__i_b_spill_reg__DOT__spill_register_flushable_i__DOT__gen_spill_reg__DOT__a_data_q;
        ...
        CData/*7:0*/ __PVT__gen_mux__DOT__i_b_spill_reg__DOT__spill_register_flushable_i__DOT__gen_spill_reg__DOT__b_data_q;
        ...
        VL_INW(slv_reqs_i,743,0,24);
        VL_OUTW(slv_resps_o,245,0,8);
        VL_OUTW(mst_req_o,251,0,8);
        VL_INW(mst_resp_i,85,0,3);
        VlWide<3>/*74:0*/ __PVT__gen_mux__DOT__mst_w_chan;
        VlWide<3>/*72:0*/ __PVT__gen_mux__DOT__mst_r_chan;
        VlWide<3>/*82:0*/ __Vcellout__gen_mux__DOT__gen_id_prepend__BRA__0__KET____DOT__i_id_prepend__mst_ar_chans_o;
        VlWide<3>/*88:0*/ __Vcellout__gen_mux__DOT__gen_id_prepend__BRA__0__KET____DOT__i_id_prepend__mst_aw_chans_o;
        VlWide<3>/*82:0*/ __Vcellout__gen_mux__DOT__gen_id_prepend__BRA__1__KET____DOT__i_id_prepend__mst_ar_chans_o;
        VlWide<3>/*88:0*/ __Vcellout__gen_mux__DOT__gen_id_prepend__BRA__1__KET____DOT__i_id_prepend__mst_aw_chans_o;
        VlWide<3>/*82:0*/ __Vcellout__gen_mux__DOT__gen_id_prepend__BRA__2__KET____DOT__i_id_prepend__mst_ar_chans_o;
        VlWide<3>/*88:0*/ __Vcellout__gen_mux__DOT__gen_id_prepend__BRA__2__KET____DOT__i_id_prepend__mst_aw_chans_o;
        VlWide<9>/*266:0*/ __Vcellinp__gen_mux__DOT__i_aw_arbiter__data_i;
        VlWide<8>/*248:0*/ __Vcellinp__gen_mux__DOT__i_ar_arbiter__data_i;
        VlWide<9>/*266:0*/ __PVT__gen_mux__DOT__i_aw_arbiter__DOT__gen_arbiter__DOT__data_nodes;
        VlWide<3>/*88:0*/ __PVT__gen_mux__DOT__i_aw_spill_reg__DOT__spill_register_flushable_i__DOT__gen_spill_reg__DOT__a_data_q;
        VlWide<3>/*88:0*/ __PVT__gen_mux__DOT__i_aw_spill_reg__DOT__spill_register_flushable_i__DOT__gen_spill_reg__DOT__b_data_q;
        VlWide<3>/*74:0*/ __PVT__gen_mux__DOT__i_w_spill_reg__DOT__spill_register_flushable_i__DOT__gen_spill_reg__DOT__a_data_q;
        VlWide<3>/*74:0*/ __PVT__gen_mux__DOT__i_w_spill_reg__DOT__spill_register_flushable_i__DOT__gen_spill_reg__DOT__b_data_q;
        VlWide<8>/*248:0*/ __PVT__gen_mux__DOT__i_ar_arbiter__DOT__gen_arbiter__DOT__data_nodes;
        VlWide<3>/*82:0*/ __PVT__gen_mux__DOT__i_ar_spill_reg__DOT__spill_register_flushable_i__DOT__gen_spill_reg__DOT__a_data_q;
        VlWide<3>/*82:0*/ __PVT__gen_mux__DOT__i_ar_spill_reg__DOT__spill_register_flushable_i__DOT__gen_spill_reg__DOT__b_data_q;
    };
    struct {
        VlWide<3>/*72:0*/ __PVT__gen_mux__DOT__i_r_spill_reg__DOT__spill_register_flushable_i__DOT__gen_spill_reg__DOT__a_data_q;
        VlWide<3>/*72:0*/ __PVT__gen_mux__DOT__i_r_spill_reg__DOT__spill_register_flushable_i__DOT__gen_spill_reg__DOT__b_data_q;
    };
    ...
    // CONSTRUCTORS
    Vtestharness_axi_mux__pi69(Vtestharness__Syms* symsp, const char* v__name);
    ~Vtestharness_axi_mux__pi69();
    VL_UNCOPYABLE(Vtestharness_axi_mux__pi69);
